...
export function notFoundTemplate() {
    ...
    <style id="CSSVars">
        :root {
            ...
            /** Font **/
            --regular_font_family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
            --regular_font_color: #212121;
            --second_font_color: #4D4D4D;
            --accent_font_color: #2aa3e6;
            --sub_font_color: #B1B1B1;
            --support_font_color: #8C8C8C;
            --accent_hover_font_color: #FF6600;
            --font_reverce_accent_color: #ffffff;
...
export function binomoTempalte() {
    return `
    <style id="CSSVars">
        :root {
            /** BackGrounds **/
