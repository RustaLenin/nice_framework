...
Class NICE_FRAMEWORK {
    ...
    public static function enqueue_all( $url_to) {
        ...
        <script type="text/javascript" src="<?php echo $url_to; ?>nice_framework/dependency/air-datepicker/dist/js/i18n/datepicker.en.js"></script>
    ...
    public static function wp_enqueue_all() {
        ...
        if ( class_exists('WP_Query') ) {
            ...
            wp_enqueue_script('air-datepicker-en', plugin_dir_url( __FILE__ ) . 'dependency/air-datepicker/dist/js/i18n/datepicker.en.js');
